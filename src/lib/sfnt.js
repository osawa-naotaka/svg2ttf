...
function Font() {
    ...
    Object.defineProperty(this, "ySubscriptXSize", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_ySubscriptXSize) ? this.int_ySubscriptXSize : this.width * 0.6347,
                10,
            );
        },
        set: function (value) {
    ...
    Object.defineProperty(this, "ySubscriptYSize", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_ySubscriptYSize)
    ...
    Object.defineProperty(this, "ySubscriptYOffset", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_ySubscriptYOffset)
    ...
    Object.defineProperty(this, "ySuperscriptXSize", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_ySuperscriptXSize) ? this.int_ySuperscriptXSize : this.width * 0.6347,
                10,
            );
        },
        set: function (value) {
    ...
    Object.defineProperty(this, "ySuperscriptYSize", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_ySuperscriptYSize)
    ...
    Object.defineProperty(this, "ySuperscriptYOffset", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_ySuperscriptYOffset)
    ...
    Object.defineProperty(this, "yStrikeoutSize", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_yStrikeoutSize)
    ...
    Object.defineProperty(this, "yStrikeoutPosition", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_yStrikeoutPosition)
    ...
    Object.defineProperty(this, "lineGap", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_lineGap) ? this.int_lineGap : (this.ascent - this.descent) * 0.09,
                10,
            );
        },
        set: function (value) {
    ...
    Object.defineProperty(this, "underlinePosition", {
        get: function () {
            return parseInt(
                !_.isUndefined(this.int_underlinePosition)
...
export { Font, Glyph, Contour, Point, SfntName, toTTF };
